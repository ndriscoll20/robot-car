...
class Wheelie (Node):
    ...
    def __init__(self, name,
                 pinRightFwd, pinRightRev, pinRightPwm, 
                 pinLeftFwd, pinLeftRev, pinLeftPwm,
        ...
        self._rightWheel = Motor(pinRightFwd, pinRightRev, pinRightPwm, frequency)
        self._leftWheel = Motor(pinLeftFwd, pinLeftRev, pinLeftPwm, frequency)
